...
{
    'name': 'Car Repair and Auto Body Shop Management Odoo App',
    'version': '14.0.0.4',
    'category': 'Industries',
...
Manage car repairing
==================================

It handles the full repairing workflow:

car Repair car Diagnosis car Work Order car
...
Gérer la réparation de la car

Il gère le flux de travail de réparation complète:

** Réparation de fleet ** Diagnostic de fleet ** Commande de car **
...
* * Après Workorder *: Une facture préliminaire est créée et doit être payée après la fin du travail.
     ...
     -Réparation d'ordinateur, entretien informatique, entretien et opération, réparation d'entretien, industrie de service. Réparation d'ordinateurs. Réparation de produits. Maintenance, réparation et maintenance de la fleet. Gestion de la réparation de produits
       ordre de réparation
       réparer le flux de travail
       gestion de réparation de produit
       ordre de réparation de car
       Repiar car Diagnostic
       travail de réparation de car
       gestion de la réparation de car avec flux dynamique
       ordre de réparation pour la car
       reçu de réparation de car
       Gestion de maintenance et de réparation pour car
    ...
    'depends': ['base','sale_management','stock','project','account','website','website_sale','attachment_indexation','hr_timesheet','fleet'],
    'data': [
                "security/car_repair_security.xml",
                "security/ir.model.access.csv",
                "views/setting_view.xml",
                "views/configuration_view.xml",
                "views/car_repairs.xml",
                "views/car_view.xml",
                "report/car_repair.xml",
                "report/car_repair_report_view.xml",
                "report/car_label_report_view.xml",
                "data/mail_template_data.xml",
                "views/car_repair_template.xml",
    ...
    'live_test_url':'https://youtu.be/MVWOG_7OZVw',
}
